<?php
/*
الملف كتابة مسلم | Muslim مافي داعي تسرق الملف وتغير  حقوق
تسرق تثبت فشلك
@DevM17
*/
ob_start();

define('API_KEY','7878303288:AAGOQYyUlV21omiJxKvgg-pPVjpMLiXAFIU'); #التوكن 
...
إذا البوت حذف النقاط راسلني @s_a_ik_o",
]);
if($data == 'c'){
  bot('EditMessageText',[
'chat_id'=>$chat_id,
